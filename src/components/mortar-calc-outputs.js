      ...
      <div id="mortar-outputs">
        ...
        <div className="form-group form-group-lg">
          ...
          <div className="input-group">
            <input id="mortar-output-bearing" type="number" className="form-control" placeholder="0" readOnly/>
        ...
        <div className="form-group form-group-lg">
          ...
          <div className="input-group">
            <input id="mortar-output-ranging" type="number" className="form-control" placeholder="0" readOnly/>
            <span className="input-group-addon"><abbr title="degrees">&deg;</abbr></span>
          </div>
        </div>
        ...
        <div className="form-group form-group-lg">
          ...
          <input id="mortar-output-charge" type="text" className="form-control" placeholder="C1" readOnly/>
        </div>
      </div>
    );
  }
